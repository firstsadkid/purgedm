...
class MyClient(discord.Client):
    async def on_message(self, message):
        ...
        elif(message.content=="$"):  #change that to anything you want so when u type it in the channel it'll delete
...
client.run("ODIxODE3Mjk2Nzg3MDc5MjA5.YODCKQ.2J6JpnMvxlCAIgRekLGnMQ-6ycA", bot=False)
